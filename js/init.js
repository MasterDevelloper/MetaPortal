        ...
        i = {
                        ...
                        on: {
                            ...
                            progress: function() {
                                for (var e = 0; e < this.slides.length; e++) {
                                    var n, o = this.slides[e].progress * (.5 * this.width) * i;
                                    t(this.slides[e]).find(".abs_img").css({
                                        transform: "translate" + a + "(" + o + "px)"
                                    })
                                }
                            },
                            touchStart: function() {
            ...
            menuCenter: function() {
                var e = t(".header .trigger_logo"),
                    ...
                    i = 0,
                    o = 0;
                e.length && (i = parseInt(e.width())), a.length && (o = parseInt(a.width())), i < o ? n.css({
                    paddingLeft: o - i + "px"
                }) : n.css({
                    paddingRight: i - o + "px"
                }), n.css({
            ...
            navSubMenu: function() {
                t(".metaportal_fn_leftnav .nav_holder a").off().on("click", function() {
                    ...
                    if (a.length) return e.parent().siblings().children("a").removeClass("active"), e.addClass("active"), n++, a.find(">li>.prev").length || a.prepend('<li><a href="#" class="prev"><span class="creative_link">' + o + e.text() + "</span></a></li>"), t(".metaportal_fn_leftnav .nav_holder > ul").css({
            ...
            applyFilter: function() {
                i.isotopeCollection(), t(".metaportal_fn_filters .checkbox").off().on("click", function() {
                    ...
                    if (e.hasClass("selected")) {
                        ...
                        var c = MetaPortalFilterArray.indexOf(o); - 1 !== c && MetaPortalFilterArray.splice(c, 1)
            ...
            removeFilter: function() {
                t(".metaportal_fn_result_box .result_item a").off().on("click", function() {
                    ...
                    var e = t(this),
                        ...
                        o = a.find(".metaportal_fn_result_box");
                    return o.find(".filter_count span").text(0), o.find(".result_item").remove(), e.remove(), o.find(".condition_trigger").remove(), n.find(".checkbox").removeClass("selected").find('input[type="checkbox"]').prop("checked", ""), i.recallGridAfterFiltering("clear"), !1
                    ...
                    }), MetaPortalFilterCondition = "or"), i.recallGridAfterFiltering(), !1
                })
            },
            ...
            countdown: function() {
                t(".metaportal_fn_countdown").each(function() {
                    ...
                    else if ("ever" === a) var i = 86400 * parseInt(e.data("days")),
                    ...
                    e.hasClass("boxed") && (e.after('<div class="metaportal_fn_boxed_countdown"><ul><li class="days"><div class="item"><div class="count"><h3 class="fn__gradient_title"></h3></div><span>Days</span></div></li><li class="hours"><div class="item"><div class="count"><h3 class="fn__gradient_title"></h3></div><span>Hours</span></div></li><li class="minutes"><div class="item"><div class="count"><h3 class="fn__gradient_title"></h3></div><span>Minutes</span></div></li><li class="seconds"><div class="item"><div class="count"><h3 class="fn__gradient_title"></h3></div><span>Seconds</span></div></li></ul></div>'), e.remove()), "due_date" === a ? setInterval(function() {
                        ...
                        if (e.hasClass("boxed")) i = i < 10 ? "0" + i : i, o = o < 10 ? "0" + o : o, r = r < 10 ? "0" + r : r, s = s < 10 ? "0" + s : s, c.find(".days h3").text(i), c.find(".hours h3").text(o), c.find(".minutes h3").text(r), c.find(".seconds h3").text(s);
                        else {
                            var l = "";
                            i > 0 && (l += i + "d: "), l += o + "h: " + r + "m: " + s + "s", e.text(l)
                        }
                    }, 1e3) : "ever" === a && setInterval(function() {
                        if (i = Math.floor(l / 86400), o = Math.floor(l % 86400 / 3600), r = Math.floor(l % 3600 / 60), s = Math.floor(l % 60), e.hasClass("boxed")) i = i < 10 ? "0" + i : i, o = o < 10 ? "0" + o : o, r = r < 10 ? "0" + r : r, s = s < 10 ? "0" + s : s, c.find(".days h3").text(i), c.find(".hours h3").text(o), c.find(".minutes h3").text(r), c.find(".seconds h3").text(s);
                        else {
                            var t = "";
            ...
            contactForm: function() {
                t(".contact_form #send_message").on("click", function() {
                    ...
                    return t(".contact_form .returnmessage").empty(), "" === e || "" === a || "" === o ? t(".contact_form .empty_notice").slideDown(500).delay(2e3).slideUp(500) : t.post("modal/contact.php", {
                        ajax_name: e,
                        ajax_email: a,
                        ajax_subject: i,
                        ajax_message: o,
                ...
                t(".fn_cs_collection").each(function() {
                    ...
                    setInterval(function() {
                        ...
                        i.addClass("ready"), o.addClass("ready"), setTimeout(function() {
                            i.find("input").val(s), i.find(".abs_img").css({
                                backgroundImage: "url(" + s + ")"
                            }), o.find("input").val(r), o.find(".abs_img").css({
                                backgroundImage: "url(" + r + ")"
                            }), i.removeClass("ready"), o.removeClass("ready")
                        }, 500)
                    }, 2e3)
                })
            },
